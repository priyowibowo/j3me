 ...
 * FlightManager View
 */
class ApinorwegianViewRoute extends JView
{
  /**
  ...
  protected function addToolBar()
  {
    ...
    JToolBarHelper::title($isNew ? JText::_('COM_FLIGHTMANAGER_MANAGER_FLIGHTMANAGER_NEW') : JText::_('COM_FLIGHTMANAGER_MANAGER_FLIGHTMANAGER_EDIT'), 'flightmanager');
