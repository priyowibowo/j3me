...
<form
	action="<?php echo JRoute::_('index.php?option=com_apinorwegian&view=apinorwegian&layout=booking'); ?>"
	method="post" name="adminForm" id="apinorwegian-form"
	class="form-validate">
...
<table width="100%">
	...
	<tr>
		<td width="10%"><input type="hidden" name="task"
			value="apinorwegian.booking" /> <input type="submit" name="submit"
			value="Submit" /></td>
		<td width="1%"></td>
		<td width="39%"></td>
	</tr>
