...
<h3 class="h3top">Vælg pakke til <?php echo $this->arrival['city']['displayName'] ?></h3>
<!--h4 class="h4top"> </h4-->
<?php
        ...
        $package .= "</ul></td>
                     <td class=last>
                        <ul class=checklistcf>";
                          $package .= ($this->pkgdetails[0]->pool) ? "<li class=check><span>Pool</span></li>" : "<li><span>Pool</span></li>";
                          ...
                          $package .= ($this->pkgdetails[0]->localcentre!='') ? "<li class=check><span>Centrum: ".$this->pkgdetails[0]->localcentre."</span></li>" : "<li><span>Lokalt centrum</span></li>";
...
//                            }
        ...
        $package .= "</ul>
            ...
            <input type=hidden name=traveltype value=".base64_encode(0)." />
            <input type=hidden name=fromdest value=".base64_encode($this->departure['city']['iataAirportCode'])." />
            <input type=hidden name=todest value=".base64_encode($this->arrival['city']['iataAirportCode'])." />
