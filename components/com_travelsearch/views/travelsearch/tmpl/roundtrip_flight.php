    ...
    <?php 
        ...
        if(is_object($value)){
            $tbody .= "<tr>";
                ...
                $tbody .= "<td><a class=tes>".substr($arivedest[1], 0, 5)." </a>".$this->departure['city_dest']['displayName']."</td>";
    ...
    foreach($this->arrival['flight'] as $key => $value){
      if(is_object($value)){
        $tbody .= "<tr>";
            ...
            $tbody .= "<td><a class=tes>".substr($arrivehome[1], 0, 5)." </a>".$this->arrival['city_dest']['displayName']."</td>";
            $tbody .= "<td>".$value->flightCode."</td>";
//            if(is_object($value->bookingClasses)){
//                $tbody .= "<td>".$value->bookingClasses->seatsAvailable."</td>";
//            } else {
