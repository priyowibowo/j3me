...
<table width="100%" class="flight">
    ...
    <?php 
        ...
        if(is_array($this->departure['flight'][OriginDestinationInformation])){
            $tbody .= "<tr>";
                $tbody .= "<td><a class=tes>".substr($depart[1], 0, 5)."</a> ".$this->departure['city']."</td>";
                $tbody .= "<td><a class=tes>".substr($arivedest[1], 0, 5)."</a> ".$this->arrival['city_dest']."</td>";
...
<table width="100%" class="flight">
  ...
  <?php 
    $tbody = "<tbody>";
      ...
      if(is_array($this->arrival['flight'][OriginDestinationInformation])){
        $tbody .= "<tr>";
            $tbody .= "<td><a class=tes>".substr($depart[1], 0, 5)." </a>".$this->arrival['city']."</td>";
            $tbody .= "<td><a class=tes>".substr($arrivehome[1], 0, 5)." </a>".$this->departure['city_dest']."</td>";
